...
<%--        ${fn:split(loginMember.memberAddress, '^^^')[0]}
            ...
            <c:set var="addr" value="${fn:split(loginMember.memberAddress, '^^^')}"/>
                    ...
                    <div class="myPage-row info-address">
                        <input type="text" id="postCode" name="memberAddress" placeholder="우편번호" value="${addr[0]}">
                        <button type="button" onclick="DaumPostcode()">검색</button>
                    </div>

                    <div class="myPage-row info-address">
                        <input type="text" id="address" name="memberAddress"  placeholder="도로명/지번 주소" value="${addr[1]}">                
                    </div>

                    <div class="myPage-row info-address">
                        <input type="text" id="detailAddress" name="memberAddress"  placeholder="상세 주소" value="${addr[2]}">                
                    </div>
