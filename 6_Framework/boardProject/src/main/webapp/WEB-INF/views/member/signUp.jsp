    ...
    <main>
        ...
        <section class="signUp-content">
            ...
            <form action="/member/signUp" method="POST" name="signUpFrm" id="signUpFrm">
                ...
                <div class="signUp-input-area">
                    <input type="text" id="postCode" name="memberAddress" placeholder="우편번호" maxlength="6">
                ...
                <div class="signUp-input-area">
                    <input type="text" id="address" name="memberAddress" placeholder="도로명/지번 주소">
                </div>


                <div class="signUp-input-area">
                    <input type="text" id="detailAddress" name="memberAddress" placeholder="상세 주소">
                </div>
