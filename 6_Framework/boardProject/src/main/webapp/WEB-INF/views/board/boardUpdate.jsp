...
<body>
    <main>
        ...
        <%-- /board2/1/1515/update?cp=1 상대경로로 작성함 -> mapping --%>
        <form action="update" method="POST" 
            ...
            <%-- mapper에서 resultMap으로 맞춰줘서 

                이미지 정보를 적절하게 매핑하는 과정을 거쳐 DTO 객체에 담으면, 
                JSP 페이지에서는 이 DTO 객체에 접근하여 데이터를 활용할 수 있습니다. 
                따라서 따로 추가적인 put 작업이나 매핑 과정이 필요하지 않습니다.
