...
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	// 오버라이드가 강제되진 않는 interface지만 자바 버전이 낮으면 오류 날 수 있어서 그냥 오버라이드함
	 ...
	 * postHandle : 후처리 : Controller -> Dispacther Servlet 사이
	 * afterCompletion : (뷰 완성 후) : View Resolver -> Dispatcher Servlet
	 * 
	 * */
