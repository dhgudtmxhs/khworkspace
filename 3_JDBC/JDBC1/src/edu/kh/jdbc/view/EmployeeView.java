...
public class EmployeeView {
	 ...
	 * 사번으로 사원 정보 조회 View
	 */
	public void selectOne() { // 1나라 while안쓰고 if쓴 뒤 객체에 담아서 객체로만 넘김.
							  // 그걸 리스트에 담아서 printList 메서드로 출력함.
	...
	public void selectSalary () { 
		System.out.println("[입력 받는 급여 이상으로 받는 모든 직원 조회]");
	...
	*/
	...
	public void updateEmployee() {
		...
		Employee emp = new Employee(); // 매개변수 4개짜리 생성자 Employee에서 만들어도 됨
		...
		// 수정 == UPDATE == DML == 성공한 행의 개수가 반환된다. == int 자료형을 사용한다.
