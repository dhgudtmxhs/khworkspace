...
// [] 는 생략 가능한 것	
	...
	/* 
		...
		# protected  	   static						  배열
	  	...
	  	- private		static final (순서상관x)			 (참조형)
	...
	*/
	...
	public void ex() {
	 ...
	 //void = student 안의 메서드 인듯? 
	// static 예약어
	
	public static String schoolName = "KH고등학교";
	
	private String name; // 캡슐화 원칙 때문에 private 
						 //-> 외부에서 접근하려면 간접 접근 방법이 필요하다.
	
	{
			name = "홍길동";  // {} = 초기화블록 : 객체 생성시 필드 값을 초기화 //
	}
	...
	public Student() {
		...
		// 앞은 public class Student//객체가 생성될 때 수행할 코드

	
	
	
		// public void ex1() {}
		// -> void가 반환형 (생성자는 존재하지 않는다.)
		...
		//(default) public class student에서 public자리 . 같은 패키지 안에서만 생략 가능.
